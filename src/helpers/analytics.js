// Adapted from https://github.com/philipwalton/analyticsjs-boilerplate/blob/c6717f3d99650cd5faebb7b94ad27eb9510e62c1/src/analytics/autotrack.js
 ...
 */
export const analyticsHelperInit = trackingId => {
 ...
 */
const createTracker = trackingId => {
...
const trackErrors = () => {
  ...
  const loadErrorEvents = (window.__e && window.__e.q) || [] // eslint-disable-line no-underscore-dangle
...
const sendNavigationTimingMetrics = () => {
  ...
  const allValuesAreValid = (...values) => {
    return values.every(value => value > 0 && value < 6e6) // eslint-disable-line no-magic-numbers
  }
